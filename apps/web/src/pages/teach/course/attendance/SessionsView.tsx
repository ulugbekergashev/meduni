    ...
    <div>
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative min-w-[150px] flex-1">
          ...
          <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder={t("searchSession")} className="w-full rounded-control border border-line bg-surface py-2 pl-9 pr-3 text-note outline-none focus:border-brand" />
        </div>
                    ...
                    <tr key={s.id} className="border-b border-line last:border-0 hover:bg-bg">
                      ...
                      <td className="px-3 py-2.5">
                        <div className="flex items-center justify-end gap-1">
                          <button onClick={() => setMarking(s.id)} className="inline-flex items-center gap-1 rounded-control bg-brand-soft px-2.5 py-1 text-note font-semibold text-brand-deep hover:bg-brand/10">
